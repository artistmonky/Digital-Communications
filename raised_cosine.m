...
% Inputs:
% a (AKA alpha) = excess bandwidth
% m = oversampling factor (i.e. number of samples per symbol period)
% length = number of symbol periods to evaluate on either side of the pulse center
