...
b = 0.5 * log2(1 + SNR_mfb_linear / Gap_linear); 
% Q: Why are there 2 different definitions of b? Is there supposed to be a 0.5 or not?
% A: There is supposed to be a half! There's only no half if it's passband.
% This part is baseband, so we use a half.
disp('Q1b:')
...
%% Q2a. Received Vector Model
% r = Ub + n
% r = q[n]'
% U is a 13 x 21 matrix given by: 
% U = [q[-4] q[-3] ...     0;
%      0     q[-4] ...     0;
%      ......................
%      0     0     ...  q[-4]]
